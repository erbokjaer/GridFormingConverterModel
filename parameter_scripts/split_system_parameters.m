...
% Move row 7 to row 23 and shift rows 8:23 up by one
row7 = A(7,:);           % store original row 7
A(7:22,:) = A(8:23,:);   % shift rows 8..23 up to 7..22
A(23,:) = row7;          % place original row 7 into row 23
